...
export default () => {
    ...
    return (
        <div className="flex flex-col bg-white w-full"> {/* Añadido w-full para asegurar ancho completo */}
            ...
            <div className="flex justify-between items-center bg-[#FFFFFFCC] py-4 px-10 sticky top-0 z-50 backdrop-blur-sm">
                ...
                <img
                    ...
                    className="w-[148px] h-[42px] object-contain" // Cambiado a object-contain
                    alt="Logo"
                />

                {/* Menú Central (Centrado mejor usando flex-1 y justify-center) */}
                ...
                {/* Botón Iniciar Sesión (Con Icono Avatar) */}
                <button 
            ...
            {/* --- HERO SECTION (Empieza YA) --- */}
            <div className="flex flex-col items-center py-[156px]"
                style={{ background: "linear-gradient(180deg, #AAD5FF, #E7E7F3)" }}>
                <span className="text-[#0D0D1B] text-7xl font-bold text-center w-full max-w-[1029px] mb-[17px] leading-tight">
                    {"Encuentra la Universidad de \ntus sueños"}
                </span>
                <div className="mb-8">
                    <span className="text-[#4C4C9A] text-xl">
                ...
                <button className={`flex items-center bg-[#1313EC] py-5 px-10 gap-2 rounded-full border-0 ${buttonPressEffect}`}
                    ...
                    <img
                        src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/y0WLx2RbqX/phwmyikc_expires_30_days.png"}
            ...
            {/* --- IMÁGENES FLOTANTES (Con separación de ~1cm / 40px) --- */}
            <div className="flex items-center justify-center bg-white relative py-[74px] my-10 overflow-hidden">
                {/* Separación aplicada con my-10 (margin-y: 2.5rem ≈ 40px) */}
                
                {/* Imágenes (Estructura simplificada para evitar desbordes) */}
                ...
                {/* Elementos decorativos flotantes absolutos */}
            ...
            <div className="flex flex-col bg-[#F6F6F8] py-20 px-[210px] gap-16">
                <div className="flex flex-col gap-4 text-center">
                    <span className="text-[#0D0D1B] text-4xl font-bold">
                        {"¿Por qué elegir UniDream?"}
                    </span>
                    <span className="text-[#4C4C9A] text-base mx-auto max-w-[706px] whitespace-pre-line">
                    ...
                    <div className="flex justify-start">
                        <div className="flex items-center bg-white p-8 gap-6 rounded-full border border-[#E7E7F3] shadow-sm max-w-4xl">
                            ...
                            <div>
                                ...
                                <p className="text-[#4C4C9A] text-base">Trabaja con un sistema avanzado de IA con el cuál entenderá todos tus gustos, pasatiempos y aspiraciones.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <div className="flex items-center bg-white p-8 gap-6 rounded-full border border-[#E7E7F3] shadow-sm max-w-4xl">
                            <div className="text-right">
                                ...
                                <p className="text-[#4C4C9A] text-base">Su base de datos reúne a todas las universidades registradas por la Senescyt en el Ecuador.</p>
                            </div>
                    ...
                    <div className="flex justify-start">
                        <div className="flex items-center bg-white p-8 gap-6 rounded-full border border-[#E7E7F3] shadow-sm max-w-4xl">
                            ...
                            <div>
                                ...
                                <p className="text-[#4C4C9A] text-base">UniDream reúne a cada una de estas instituciones y se garantiza que la información siempre estará actualizada.</p>
                            </div>
                        </div>
                    </div>

                    {/* Tarjeta 4 (Alineada a la derecha) */}
                    <div className="flex justify-end">
                        <div className="flex items-center bg-white p-8 gap-6 rounded-full border border-[#E7E7F3] shadow-sm max-w-4xl">
                            <div className="text-right">
                                <h3 className="text-[#0D0D1B] text-xl font-bold">Plan de Carrera</h3>
                                <p className="text-[#4C4C9A] text-base">Visualiza tu futuro profesional y las oportunidades laborales de cada carrera.</p>
                            </div>
            ...
            {/* --- CÓMO FUNCIONA (Sin animaciones de click en los círculos) --- */}
            <div className="flex flex-col bg-white py-24 px-[210px] gap-16">
                <div className="text-center gap-4 flex flex-col">
                    <span className="text-[#0D0D1B] text-4xl font-bold">{"¿Cómo funciona?"}</span>
                    <span className="text-[#4C4C9A] text-base">{'Cuatro pasos simples para transformar tu futuro académico.'}</span>
                </div>

                <div className="flex justify-between items-start gap-4">
                    {/* PASO 1 - Cambiado de button a div */}
                    <div className="flex flex-1 flex-col items-center gap-4">
                        ...
                        <span className="text-[#4C4C9A] text-sm text-center">{"Un click en Empieza ya te llevará a encontrar la universidad de tus sueños"}</span>
                    </div>

                    {/* PASO 2 - Cambiado de button a div */}
                    <div className="flex flex-1 flex-col items-center gap-4">
                        ...
                        <span className="text-[#4C4C9A] text-sm text-center">{"Cuéntanos cuáles son tus habilidades, gustos, y qué buscas en tu futuro."}</span>
                    </div>

                    {/* PASO 3 - Cambiado de button a div */}
                    <div className="flex flex-1 flex-col items-center gap-4">
                        <div className="flex justify-center items-center bg-[#1313EC33] w-20 h-20 rounded-full">
                            <span className="text-[#1313EC] text-2xl font-bold">3</span>
                        </div>
                        <span className="text-[#0D0D1B] text-lg font-bold">{"Compara opciones"}</span>
                        <span className="text-[#4C4C9A] text-sm text-center">{"Analiza mallas, costos y beneficios de las mejores universidades."}</span>
                    </div>

                    {/* PASO 4 - Cambiado de button a div */}
                    <div className="flex flex-1 flex-col items-center gap-4">
                        <div className="flex justify-center items-center bg-[#1313EC33] w-20 h-20 rounded-full">
                            <span className="text-[#1313EC] text-2xl font-bold">4</span>
                        </div>
                        <span className="text-[#0D0D1B] text-lg font-bold">{"Postula"}</span>
                        <span className="text-[#4C4C9A] text-sm text-center">{"Si quieres saber más información puedes ver las listas de Universidades y carreras."}</span>
                    </div>
                </div>
            </div>

            {/* --- FOOTER (Reordenado y sin iconos extra) --- */}
            <div ref={footerRef} className="bg-[#0A0A14] py-16 px-20">
                {/* Grid layout para mejor orden */}
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20 text-white">
                    ...
                    <div className="col-span-1 flex flex-col gap-6">
                        ...
                        {/* ICONOS BORRADOS AQUÍ COMO PEDISTE */}
                    </div>

                    {/* Columna 2: Plataforma */}
                    <div className="col-span-1 flex flex-col gap-4">
                        <h4 className="text-lg font-bold mb-2">Plataforma</h4>
                        <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Directorio de Carreras</span>
                        <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Ranking de Universidades</span>
                        <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Datos 100% enfocados en el país</span>
                        <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Test Vocacional IA</span>
                    </div>

                    {/* Columna 3: Legal (Agregado para balancear si quieres, o espacio vacío) */}
                    <div className="col-span-1 flex flex-col gap-4">
                         {/* Espacio para futuros links o vacío para mantener estructura */}
                    </div>
                    ...
                    <div className="col-span-1 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3">
                            <input 
                                ...
                                className="bg-[#FFFFFF1A] text-white p-3 rounded-full border border-[#FFFFFF33] outline-none focus:border-blue-500 transition-colors"
                            />
                            <button 
